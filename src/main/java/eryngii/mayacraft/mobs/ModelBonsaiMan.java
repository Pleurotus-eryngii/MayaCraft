    ...
    public ModelBonsaiMan() {
      ...
      public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity f6)
      {
        //super.setRotationAngles(f, f1, f2, f3, f4, f5, f6);
    	  ...
    	  this.Tree.rotateAngleY = f3 / (180F / (float)Math.PI);
          this.Tree.rotateAngleX = f4 / (180F / (float)Math.PI);
    	  this.Tree2.rotateAngleY = f3 / (180F / (float)Math.PI);
          this.Tree2.rotateAngleX = f4 / (180F / (float)Math.PI);
    	  this.Tree3.rotateAngleY = f3 / (180F / (float)Math.PI);
          this.Tree3.rotateAngleX = f4 / (180F / (float)Math.PI);
    	  this.Tree4.rotateAngleY = f3 / (180F / (float)Math.PI);
          this.Tree4.rotateAngleX = f4 / (180F / (float)Math.PI);
    	  this.Tree5.rotateAngleY = f3 / (180F / (float)Math.PI);
          this.Tree5.rotateAngleX = f4 / (180F / (float)Math.PI);
    	  this.Tree6.rotateAngleY = f3 / (180F / (float)Math.PI);
          this.Tree6.rotateAngleX = f4 / (180F / (float)Math.PI);
