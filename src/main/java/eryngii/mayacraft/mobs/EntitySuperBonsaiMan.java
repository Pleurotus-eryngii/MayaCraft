...
public class EntitySuperBonsaiMan extends EntityMob{
			//Entityの設定。具体的にはMOBの挙動を指定するものである。
			
			 public EntitySuperBonsaiMan(World world)
			    {
				 super(world);
				 /*AIの設定。上から
		    ...
		    this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityVillager.class, 1, true));
				...
				protected void applyEntityAttributes()
				{
					...
					this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(256D);
			    ...
			    @Override
			     ...
			     public Item getDropItem() { return MayaCraftCore.itemOpiumPoppyPlant; }
