...
public class CannabisBlock extends BlockBush implements IGrowable {
    ...
    public CannabisBlock() {
        super();
        setBlockTextureName("mayacraft:cannabis_stage_0");
...
*/
    ...
    public void registerBlockIcons(IIconRegister parIIconRegister)
    {
          ...
          // 全成長段階のテクスチャを登録
          iIcon[0] = parIIconRegister.registerIcon("mayacraft:cannabis_stage_0");
          iIcon[1] = parIIconRegister.registerIcon("mayacraft:cannabis_stage_1");
          iIcon[2] = parIIconRegister.registerIcon("mayacraft:cannabis_stage_2");
          iIcon[3] = parIIconRegister.registerIcon("mayacraft:cannabis_stage_3");
          iIcon[4] = parIIconRegister.registerIcon("mayacraft:cannabis_stage_4");
          iIcon[5] = parIIconRegister.registerIcon("mayacraft:cannabis_stage_5");
          iIcon[6] = parIIconRegister.registerIcon("mayacraft:cannabis_stage_6");
    }
