...
public class FreshOpiumPoppyBlock   extends Block implements IGrowable {
    ...
    public Item getItemDropped(int metadata, Random random, int fortune) {
    	if(metadata==1){return MayaCraftCore.itemDryOpiumPoppy;}
    	else{
    		return  MayaCraftCore.itemOpiumPoppy;}
    ...
    public void registerBlockIcons(IIconRegister parIIconRegister)
    {
          ...
          // 全成長段階のテクスチャを登録
          iIcon[0] = parIIconRegister.registerIcon("mayacraft:freshopoppy");
          iIcon[1] = parIIconRegister.registerIcon("mayacraft:dryopoppy");
